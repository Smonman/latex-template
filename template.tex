...
\lstdefinelanguage{pseudo}{
  ...
  morekeywords={function, returns, return, if, then, else, and, or, not, loop, do, while, for, switch, case, foreach, begin, end, endif},
  sensitive=false,
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]"
...
\newtcblisting{code}[1][]{
  boxsep=1pt,
  boxrule=0.8pt,
  adjusted title=\sffamily\bfseries #1,
  sharp corners,
  arc is angular,
  arc=10pt,
...
\[\abs{\frac{1}{2}x^2}  \quad \norm{\frac{1}{2}x^2}  \qquad\text{non-starred}  \]
\[\abs*{\frac{1}{2}x^2} \quad \norm*{\frac{1}{2}x^2} \qquad\text{starred}\qquad\]
\footnote{see https://tex.stackexchange.com/questions/43008/absolute-value-symbols}
